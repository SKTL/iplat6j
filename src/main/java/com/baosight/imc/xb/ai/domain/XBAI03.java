 ...
 */
public class XBAI03 extends DaoEPBase {
    ...
    public static final String FIELD_REC_REVISOR_TIME = "recRevisorTime";            /* 记录修改人时间*/
    ...
    public static final String COL_REC_REVISOR_TIME = "REC_REVISOR_TIME";            /* 记录修改人时间*/
    ...
    public static final String COL_SEND_TYPE = "SEND_TYPE";            /* 推送月*/
