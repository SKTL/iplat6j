...
(
    ...
    OPERATION_TYPE  varchar(10) default ' ' not null comment '操作类型',
    EVENT_ID        varchar(64) default ' ' not null comment '事件ID',
    DATA_REGION     varchar(10) default ' ' not null comment '数据存放位置',
    BLOCK_ID        varchar(32) default ' ' not null comment '数据块ID',
    ATTR_KEY        varchar(32) default ' ' not null comment 'attr属性key',
    ...
    CONSTRAINT PK_OPERATE_RELA PRIMARY KEY (SERVICE_ENAME, METHOD_ENAME)
)comment '服务与操作映射定义' ENGINE=INNODB DEFAULT CHARSET=UTF8 COLLATE UTF8_BIN;
...
CREATE TABLE TEDDBS0 (
                         DATASOURCE_ID VARCHAR(64) NOT NULL  DEFAULT ' ' COMMENT '数据源标识' ,
                         CONNECT_NAME VARCHAR(128) NOT NULL  DEFAULT ' ' COMMENT '连接名' ,
                         CONNECT_SCHEMA VARCHAR(128) NOT NULL  DEFAULT ' ' COMMENT '连接配置schema' ,
                         DB_TYPE VARCHAR(16) NOT NULL  DEFAULT ' ' COMMENT '数据库类型' ,
                         DB_HOST VARCHAR(255) NOT NULL  DEFAULT ' ' COMMENT '主机' ,
                         DB_PORT VARCHAR(16) NOT NULL  DEFAULT ' ' COMMENT '端口' ,
                         ITEM_DB_NAME VARCHAR(128) NOT NULL  DEFAULT ' ' COMMENT '数据库名' ,
                         ITEM_USERNAME VARCHAR(32) NOT NULL  DEFAULT ' ' COMMENT '用户名' ,
                         ITEM_PASSWORD VARCHAR(100) NOT NULL  DEFAULT ' ' COMMENT '密码' ,
                         ITEM_PARAMS VARCHAR(1024) NOT NULL  DEFAULT ' ' COMMENT '参数' ,
                         IS_AUTH VARCHAR(1) NOT NULL  DEFAULT '0' COMMENT '是否授权' ,
                         REC_CREATOR VARCHAR(16) NOT NULL  DEFAULT ' ' COMMENT '记录创建人' ,
                         REC_CREATE_TIME VARCHAR(17) NOT NULL  DEFAULT ' ' COMMENT '记录创建时间' ,
                         REC_REVISOR VARCHAR(16) NOT NULL  DEFAULT ' ' COMMENT '记录修改人' ,
                         REC_REVISE_TIME VARCHAR(17) NOT NULL  DEFAULT ' ' COMMENT '记录修改时间' ,
                         ARCHIVE_FLAG VARCHAR(1) NOT NULL  DEFAULT ' ' COMMENT '归档标记' ,
                         CONSTRAINT PK_TEDDBS0 PRIMARY KEY (DATASOURCE_ID)
)  COMMENT = '数据源信息' ENGINE=INNODB DEFAULT CHARSET=UTF8 COLLATE UTF8_BIN;
...
(
    ...
    REC_CREATOR_NAME   VARCHAR(100)   DEFAULT ' ' NOT NULL COMMENT '记录创建者姓名',
    REC_CREATE_TIME    VARCHAR(17)   DEFAULT ' ' NOT NULL COMMENT '记录创建时间',
    REC_REVISOR        VARCHAR(16)   DEFAULT ' ' NOT NULL COMMENT '记录修改人员',
    REC_REVISOR_NAME   VARCHAR(100)   DEFAULT ' ' NOT NULL COMMENT '记录修改人员姓名',
    REC_REVISE_TIME    VARCHAR(17)   DEFAULT ' ' NOT NULL COMMENT '记录修改时间',
    TENANT_ID          VARCHAR(64)   DEFAULT ' ' NOT NULL COMMENT '租户',
    ARCHIVE_FLAG       VARCHAR(1)    DEFAULT ' ' NOT NULL COMMENT '归档标记',
    TIME_STAMP         VARCHAR(18)   DEFAULT ' ' NOT NULL COMMENT '时间序列号',
    GD_CONTENT         VARCHAR(1000) DEFAULT ' ' NOT NULL COMMENT '内容',
    FB_STATE           VARCHAR(2)    DEFAULT ' ' NOT NULL COMMENT '发布状态',
    ORDER_IDENTIFY     VARCHAR(4)    DEFAULT ' ' NOT NULL COMMENT '排序标识',
    TITLE              VARCHAR(100)  DEFAULT ''  NOT NULL COMMENT '标题',
    MSG_TYPE           VARCHAR(20)   DEFAULT ''  NOT NULL COMMENT '公告类别',
    REC_PUBLISH_TIME   VARCHAR(14)   DEFAULT ''  NOT NULL COMMENT '发布时间',
    REC_PUBLISHER      VARCHAR(20)   DEFAULT ''  NOT NULL COMMENT '发布人',
    REC_PUBCANCEL_TIME VARCHAR(14)   DEFAULT ''  NOT NULL COMMENT '取消发布时间',
    PRIMARY KEY (TIME_STAMP)
)ENGINE=INNODB DEFAULT CHARSET=UTF8 COLLATE UTF8_BIN COMMENT='公告信息表';

CREATE TABLE TEDFA12
(
    TIME_STAMP VARCHAR(18)  DEFAULT '' NOT NULL COMMENT '序列号',
    FILE_NAME  VARCHAR(50)  DEFAULT '' NOT NULL COMMENT '附件名',
    FILE_URL   VARCHAR(120) DEFAULT '' NOT NULL COMMENT '附件URL'
)ENGINE=INNODB DEFAULT CHARSET=UTF8 COLLATE UTF8_BIN COMMENT='公告附件关联表';

CREATE TABLE TEDFA13
(
    REC_CREATOR      VARCHAR(16)  DEFAULT ' ' NOT NULL COMMENT '记录创建人',
    REC_CREATOR_NAME VARCHAR(100) DEFAULT ' ' NOT NULL COMMENT '记录创建人姓名',
    REC_REVISOR      VARCHAR(16)  DEFAULT ' ' NOT NULL COMMENT '记录修改人',
    REC_REVISOR_NAME VARCHAR(100) DEFAULT ' ' NOT NULL COMMENT '记录修改人姓名',
    REC_REVISE_TIME  VARCHAR(17)  DEFAULT ' ' NOT NULL COMMENT '记录修改时间',
    REC_CREATE_TIME  VARCHAR(17)  DEFAULT ' ' NOT NULL COMMENT '记录创建时间',
    TENANT_ID        VARCHAR(64)  DEFAULT ' ' NOT NULL COMMENT '租户',
    ARCHIVE_FLAG     VARCHAR(1)   DEFAULT ' ' NOT NULL COMMENT '归档标记',
    UUID             VARCHAR(32)  DEFAULT ' ' NOT NULL COMMENT 'ID',
    PROJECT_ENAME    VARCHAR(32)  DEFAULT ' ' NOT NULL COMMENT '所属系统',
    FORM_ENAME       VARCHAR(60)  DEFAULT ' ' NOT NULL COMMENT '画面英文',
    COLOR            VARCHAR(60)  DEFAULT ' ' NOT NULL COMMENT '颜色',
    FORM_CNAME       VARCHAR(60)  DEFAULT ' ' NOT NULL COMMENT '画面中文',
    FORM_GROUP       VARCHAR(200) DEFAULT ' ' NOT NULL COMMENT '分组',
    DEL_FLAG         INTEGER      DEFAULT 0   NOT NULL COMMENT '记录删除标记',
    FILE_URL         VARCHAR(500) DEFAULT ' ' NOT NULL COMMENT '文件下载路径',
    FORM_TYPE        VARCHAR(3)   DEFAULT ' ' NOT NULL COMMENT '类型',
    FILE_NAME        VARCHAR(200) DEFAULT ' ' NOT NULL COMMENT '文件名',
    SORT_ID          VARCHAR(20)  DEFAULT ' ' NOT NULL COMMENT '排序编号',
    IF_GROUP         VARCHAR(5)   DEFAULT ' ' NOT NULL COMMENT '是否显示分组',
    PRIMARY KEY (UUID)
)ENGINE=INNODB DEFAULT CHARSET=UTF8 COLLATE UTF8_BIN COMMENT='快捷通道信息表';
...
CREATE TABLE TEDFM00 (
        DIRECTORY_ID VARCHAR(32) DEFAULT ' ' NOT NULL COMMENT '目录标识',
        DIRECTORY_ENAME VARCHAR(32) DEFAULT ' ' NOT NULL COMMENT '目录编码',
        DIRECTORY_CNAME VARCHAR(80) DEFAULT ' ' NOT NULL COMMENT '目录显示名称',
        PARENT_DIRECTORY_ID VARCHAR(32) DEFAULT ' ' NOT NULL COMMENT '父目录标识',
        DIRECTORY_DESC VARCHAR(512) DEFAULT ' ' NOT NULL COMMENT '目录描述',
        REC_CREATOR VARCHAR(16) DEFAULT ' ' NOT NULL COMMENT '记录创建责任者',
        REC_CREATE_TIME VARCHAR(17) DEFAULT ' ' NOT NULL COMMENT '记录创建时刻',
        REC_REVISOR VARCHAR(16) DEFAULT ' ' NOT NULL COMMENT '记录修改责任者',
        REC_REVISE_TIME VARCHAR(17) DEFAULT ' ' NOT NULL COMMENT '记录修改时刻',
    ...
    )COMMENT ='自定义表单目录维护表' ENGINE=INNODB DEFAULT CHARSET=UTF8 COLLATE UTF8_BIN;

CREATE TABLE TEDFM01 (
        FORM_ID VARCHAR(32) DEFAULT ' ' NOT NULL COMMENT '表单标识',
        FORM_ENAME VARCHAR(20) DEFAULT ' ' NOT NULL COMMENT '表单编码',
        FORM_CNAME VARCHAR(80) DEFAULT ' ' NOT NULL COMMENT '表单中文名',
        JSON_DATA BLOB(2147483647) COMMENT '表单结构定义',
        FORM_DESC VARCHAR(512) DEFAULT ' ' NOT NULL COMMENT '表单描述',
        FORM_STATUS VARCHAR(1) DEFAULT '0' NOT NULL COMMENT '发布状态',
        TABLE_ID VARCHAR(32) DEFAULT ' ' NOT NULL COMMENT '关联数据表名',
        CATEGORY_ID VARCHAR(32) DEFAULT ' ' NOT NULL COMMENT '所在的表单目录节点',
        DESIGN_TYPE VARCHAR(1) DEFAULT '0' NOT NULL COMMENT '是否引用表单',
        REC_CREATOR VARCHAR(16) DEFAULT ' ' NOT NULL COMMENT '记录创建责任者',
        REC_CREATE_TIME VARCHAR(17) DEFAULT ' ' NOT NULL COMMENT '记录创建时刻',
        REC_REVISOR VARCHAR(16) DEFAULT ' ' NOT NULL COMMENT '记录修改责任者',
        REC_REVISE_TIME VARCHAR(17) DEFAULT ' ' NOT NULL COMMENT '记录修改时刻',
        ...
        TENANT_ID VARCHAR(64) DEFAULT ' ' NOT NULL COMMENT '租户ID',
        PRIMARY KEY (FORM_ID),
        CONSTRAINT UNI_TEDFM01 UNIQUE (FORM_ENAME)
    )COMMENT ='自定义表单数据维护表' ENGINE=INNODB DEFAULT CHARSET=UTF8 COLLATE UTF8_BIN;
...
CREATE TABLE TEWPI03 (
    FORM_FIELD_ID VARCHAR(32) DEFAULT ' ' NOT NULL COMMENT '字段的ID',
    FORM_FIELD_KEY VARCHAR(255) DEFAULT ' ' NOT NULL COMMENT '字段的编码',
    PROCESS_INSTANCE_ID VARCHAR(64) DEFAULT ' ' NOT NULL COMMENT '流程实例ID',
    FORM_FIELD_LONG_VALUE DECIMAL(20) DEFAULT 0 NOT NULL COMMENT 'Long型的值',
    FORM_FIELD_STRING_VALUE VARCHAR(255) DEFAULT ' ' NOT NULL COMMENT 'String型的值',
    FORM_FIELD_DOUBLE_VALUE DECIMAL(31,10) DEFAULT 0 NOT NULL COMMENT 'Double型的值',
    FORM_FIELD_DATE_VALUE VARCHAR(17) DEFAULT ' ' NOT NULL COMMENT 'Date型的值',
    FORM_FIELD_TEXT_VALUE VARCHAR(2000) DEFAULT ' ' NOT NULL COMMENT 'Text型的值',
    FORM_FIELD_TYPE VARCHAR(2) DEFAULT '0' NOT NULL COMMENT '类型',
    REC_CREATOR VARCHAR(16) DEFAULT ' ' NOT NULL COMMENT '记录创建责任者',
    REC_CREATE_TIME VARCHAR(17) DEFAULT ' ' NOT NULL COMMENT '记录创建时刻',
    REC_REVISOR VARCHAR(16) DEFAULT ' ' NOT NULL COMMENT '记录修改责任者',
    REC_REVISE_TIME VARCHAR(17) DEFAULT ' ' NOT NULL COMMENT '记录修改时刻',
...
)COMMENT ='流程实例相关数据表' ENGINE=INNODB DEFAULT CHARSET=UTF8 COLLATE UTF8_BIN;
...
(
    ...
    RES_ENAME          VARCHAR(500) DEFAULT ' '     NOT NULL COMMENT '资源英文名',
...
(
    ...
    FILE_NAME VARCHAR(125) NOT NULL COMMENT '文件名',
    URL VARCHAR(255) NOT NULL COMMENT '文件URL',
    REC_CREATE_TIME VARCHAR(17) NOT NULL COMMENT '记录创建时间',
    STATUS INTEGER DEFAULT 0 NOT NULL COMMENT '状态',
    REC_CREATOR VARCHAR(32) DEFAULT ' ' COMMENT '记录创建者',
    REC_CREATOR_NAME VARCHAR(100) DEFAULT ' ' COMMENT '记录创建者姓名',
    REC_REVISOR VARCHAR(32) DEFAULT ' ' COMMENT '记录修改者',
    REC_REVISOR_NAME VARCHAR(100) DEFAULT ' ' COMMENT '记录修改者姓名',
    REC_REVISOR_TIME VARCHAR(17) DEFAULT ' ' COMMENT '记录修改时间',
    DEL_FLAG SMALLINT DEFAULT 0 COMMENT '删除标记',
    ARCHIVE_FLAG VARCHAR(1) DEFAULT ' ' COMMENT '归档标记',
    SEG_NO VARCHAR(10) DEFAULT ' ' COMMENT '段号',
    REMARK VARCHAR(255) DEFAULT ' ' COMMENT '备注',
    DIFFERENCE_TIME VARCHAR(15) DEFAULT ' ' COMMENT '差异时间',
    CONSTRAINT PK_TEUDM40 PRIMARY KEY (ID)
) COMMENT = '生成文件信息表' ENGINE = INNODB DEFAULT CHARSET = UTF8 COLLATE UTF8_BIN;

CREATE TABLE TEDPI13 (
                         SEQ_ID VARCHAR(50) NOT NULL COMMENT '流水号',
                         ERROR_NUM VARCHAR(20) NOT NULL COMMENT '报错编号',
                         SYSTEM_CODE VARCHAR(10) NOT NULL COMMENT '系统别',
                         SYSTEM_NAME VARCHAR(50) NOT NULL COMMENT '系统名',
                         APP_CODE VARCHAR(10) NOT NULL COMMENT '应用编号',
                         APP_NAME VARCHAR(50) DEFAULT ' ' COMMENT '应用名',
                         FORM_ENAME VARCHAR(10) DEFAULT ' ' COMMENT '画面编号',
                         FORM_CNAME VARCHAR(50) DEFAULT ' ' COMMENT '画面名称',
                         BUTTON_ENAME VARCHAR(10) DEFAULT ' ' COMMENT '按钮编号',
                         BUTTON_CNAME VARCHAR(60) DEFAULT ' ' COMMENT '按钮名称',
                         SERVICE_ENAME VARCHAR(20) DEFAULT ' ' COMMENT '服务编号',
                         SERVICE_CNAME VARCHAR(20) DEFAULT ' ' COMMENT '服务名称',
                         ERROR_TYPE VARCHAR(20) DEFAULT ' ' COMMENT '报错分类',
                         MESSAGE_TEXT VARCHAR(200) DEFAULT ' ' COMMENT '报错描述',
                         SOLUTION VARCHAR(200) DEFAULT ' ' COMMENT '处置建议',
                         REC_CREATOR VARCHAR(32) DEFAULT ' ' COMMENT '记录创建人',
                         REC_CREATOR_NAME VARCHAR(32) DEFAULT ' ' COMMENT '记录创建人姓名',
                         REC_CREATE_TIME VARCHAR(17) DEFAULT ' ' COMMENT '记录创建时间',
                         REC_REVISOR VARCHAR(32) DEFAULT ' ' COMMENT '记录修改人',
                         REC_REVISOR_NAME VARCHAR(32) DEFAULT ' ' COMMENT '记录修改人姓名',
                         REC_REVISE_TIME VARCHAR(17) DEFAULT ' ' COMMENT '记录修改时间',
                         ARCHIVE_FLAG VARCHAR(1) DEFAULT ' ' COMMENT '归档标志',
                         MESSAGE_NUM_TEXT VARCHAR(100) DEFAULT ' ' COMMENT '报错编号描述',
                         DEL_FLAG SMALLINT DEFAULT 0 COMMENT '删除标志',
                         PARA_LIST VARCHAR(2000) DEFAULT ' ' COMMENT '参数列表',
                         USAGE_SCENE VARCHAR(2000) DEFAULT ' ' COMMENT '适用场景',
                         REMARK VARCHAR(2000) DEFAULT ' ' COMMENT '备注说明',
                         LOCALES VARCHAR(20) DEFAULT ' ' COMMENT '国际化标识',
                         CONSTRAINT PK_TEDPI13 PRIMARY KEY (SEQ_ID)
) COMMENT '系统画面报错配置应用登记表' ENGINE = INNODB DEFAULT CHARSET = UTF8 COLLATE UTF8_BIN;
...
CREATE TABLE TEDPI14 (
                         ...
                         DEL_FLAG SMALLINT DEFAULT 0 COMMENT '删除标志',
                         REMARK VARCHAR(2000) DEFAULT ' ' COMMENT '备注说明',
                         CONSTRAINT PK_TEDPI14 PRIMARY KEY (SEQ_ID)
) COMMENT '系统画面报错配置应用登记表' ENGINE = INNODB DEFAULT CHARSET = UTF8 COLLATE UTF8_BIN;
...
CREATE TABLE TEDPI15 (
                         ...
                         USAGE_SCENE VARCHAR(2000) DEFAULT ' ' COMMENT '适用场景',
                         REMARK VARCHAR(2000) DEFAULT ' ' COMMENT '备注说明',
                         CONSTRAINT PK_TEDPI15 PRIMARY KEY (SEQ_ID)
) COMMENT '统一报错履历表' ENGINE = INNODB DEFAULT CHARSET = UTF8 COLLATE UTF8_BIN;
...
(
    ...
    APP_CREATE_TIME    VARCHAR(20) COLLATE utf8_bin,
    OPERATE_RESULT     DECIMAL(5) COLLATE utf8_bin,
    OPERATE_END_TIME   VARCHAR(17) COLLATE utf8_bin,
...
(
    ...
    OPERATE_END_TIME   VARCHAR(17)  COLLATE utf8_bin default ' ' not null,
...
CREATE TABLE
    ...
    (
        ORG_ID VARCHAR(32) DEFAULT ' ' NOT NULL COMMENT '组织机构编码',
        ORG_ENAME VARCHAR(14) DEFAULT ' ' NOT NULL COMMENT '组织机构英文名',
        PROCESS_KEY VARCHAR(255) DEFAULT ' ' NOT NULL COMMENT '流程定义编码',
        PROCESS_NAME VARCHAR(255) DEFAULT ' ' NOT NULL COMMENT '流程定义名称',
        REC_CREATOR VARCHAR(16) DEFAULT ' ' NOT NULL COMMENT '记录创建责任者',
        REC_CREATE_TIME VARCHAR(17) DEFAULT ' ' NOT NULL COMMENT '记录创建时刻',
        REC_REVISOR VARCHAR(16) DEFAULT ' ' NOT NULL COMMENT '记录修改责任者',
        REC_REVISE_TIME VARCHAR(17) DEFAULT ' ' NOT NULL COMMENT '记录修改时刻',
        ARCHIVE_FLAG VARCHAR(1) DEFAULT '0' NOT NULL COMMENT '归档标记',
        TENANT_ID VARCHAR(64) DEFAULT ' ' NOT NULL COMMENT '租户ID',
        CONSTRAINT PK_TEWOG01 PRIMARY KEY (ORG_ID,PROCESS_KEY)
    )COMMENT='流程定义与组织机构关联关系表' ENGINE=INNODB DEFAULT CHARSET=UTF8 COLLATE UTF8_BIN;
...
DROP FUNCTION IF EXISTS queryMenuParentInfo;
