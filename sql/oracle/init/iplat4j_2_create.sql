...
CREATE TABLE ED_XM_SERVICE_OPERATE_RELA
(
    ...
    DATA_REGION     varchar(10) default ' ' not null ,
    BLOCK_ID        varchar(32) default ' ' not null ,
    ATTR_KEY        varchar(32) default ' ' not null ,
...
comment on table ED_XM_SERVICE_OPERATE_RELA is '服务与操作映射定义';
comment on column ED_XM_SERVICE_OPERATE_RELA.SERVICE_ENAME is '服务英文名';
comment on column ED_XM_SERVICE_OPERATE_RELA.METHOD_ENAME is '方法英文名';
comment on column ED_XM_SERVICE_OPERATE_RELA.OPERATION_TYPE is '操作类型';
comment on column ED_XM_SERVICE_OPERATE_RELA.EVENT_ID is '事件ID';
comment on column ED_XM_SERVICE_OPERATE_RELA.DATA_REGION is '数据存放位置';
comment on column ED_XM_SERVICE_OPERATE_RELA.BLOCK_ID is '数据块ID';
comment on column ED_XM_SERVICE_OPERATE_RELA.ATTR_KEY is 'attr属性key';
comment on column ED_XM_SERVICE_OPERATE_RELA.REC_CREATOR is '记录创建责任人';
comment on column ED_XM_SERVICE_OPERATE_RELA.REC_CREATE_TIME is '记录创建时刻';
comment on column ED_XM_SERVICE_OPERATE_RELA.REC_REVISOR is '记录修改责任人';
comment on column ED_XM_SERVICE_OPERATE_RELA.REC_REVISE_TIME is '记录修改时刻';
comment on column ED_XM_SERVICE_OPERATE_RELA.ARCHIVE_FLAG is '归档标记';
comment on column ED_XM_SERVICE_OPERATE_RELA.TENANT_ID is '租户ID';
ALTER TABLE ED_XM_SERVICE_OPERATE_RELA ADD CONSTRAINT PK_ED_XM_SERVICE_OPERATE_RELA  PRIMARY KEY (SERVICE_ENAME, METHOD_ENAME) ;
...
CREATE TABLE TEDCM01 (
  ...
  TENANT_ID VARCHAR2(64)  DEFAULT ' '    NOT NULL ,
  ITEM_FILTER_CODE VARCHAR2(255) DEFAULT ' ' NOT NULL,
  ITEM_FILTER_CNAME VARCHAR2(510) DEFAULT ' ' NOT NULL,
  ARCHIVE_FLAG VARCHAR2(1)  DEFAULT ' '    NOT NULL
);
...
(
    ...
    TENANT_ID          VARCHAR2(64)   DEFAULT ' ' NOT NULL,
    ARCHIVE_FLAG       VARCHAR2(1)    DEFAULT ' ' NOT NULL,
    TIME_STAMP         VARCHAR2(18)   DEFAULT ' ' NOT NULL
        CONSTRAINT PK_TEDFA11
        PRIMARY KEY,
    GD_CONTENT         VARCHAR2(1000) DEFAULT ' ' NOT NULL,
    FB_STATE           VARCHAR2(2)    DEFAULT ' ' NOT NULL,
    ORDER_IDENTIFY     VARCHAR2(4)    DEFAULT ' ' NOT NULL,
    TITLE              VARCHAR2(100)  DEFAULT ''  NOT NULL,
    MSG_TYPE           VARCHAR2(20)   DEFAULT ''  NOT NULL,
    REC_PUBLISH_TIME   VARCHAR2(14)   DEFAULT ''  NOT NULL,
    REC_PUBLISHER      VARCHAR2(20)   DEFAULT ''  NOT NULL,
    REC_PUBCANCEL_TIME VARCHAR2(14)   DEFAULT ''  NOT NULL
);
COMMENT ON TABLE TEDFA11 is '公告信息表';
COMMENT ON COLUMN TEDFA11.REC_CREATOR is '记录创建者';
COMMENT ON COLUMN TEDFA11.REC_CREATOR_NAME is '记录创建者姓名';
COMMENT ON COLUMN TEDFA11.REC_CREATE_TIME is '记录创建时间';
COMMENT ON COLUMN TEDFA11.REC_REVISOR is '记录修改人员';
COMMENT ON COLUMN TEDFA11.REC_REVISOR_NAME is '记录修改人员姓名';
COMMENT ON COLUMN TEDFA11.REC_REVISE_TIME is '记录修改时间';
COMMENT ON COLUMN TEDFA11.ARCHIVE_FLAG is '归档标记';
COMMENT ON COLUMN TEDFA11.TIME_STAMP is '时间序列号';
COMMENT ON COLUMN TEDFA11.GD_CONTENT is '内容';
COMMENT ON COLUMN TEDFA11.FB_STATE is '发布状态';
COMMENT ON COLUMN TEDFA11.ORDER_IDENTIFY is '排序标识';
COMMENT ON COLUMN TEDFA11.TITLE is '标题';
COMMENT ON COLUMN TEDFA11.MSG_TYPE is '公告类别';
COMMENT ON COLUMN TEDFA11.REC_PUBLISH_TIME is '发布时间';
COMMENT ON COLUMN TEDFA11.REC_PUBLISHER is '发布人';
COMMENT ON COLUMN TEDFA11.REC_PUBCANCEL_TIME is '取消发布时间';

CREATE TABLE TEDFA12
(
    TIME_STAMP VARCHAR2(18)  DEFAULT '' NOT NULL,
    FILE_NAME  VARCHAR2(50)  DEFAULT '' NOT NULL,
    FILE_URL   VARCHAR2(120) DEFAULT '' NOT NULL
);
COMMENT ON TABLE TEDFA12 is '公告附件关联表';
COMMENT ON COLUMN TEDFA12.TIME_STAMP is '序列号';
COMMENT ON COLUMN TEDFA12.FILE_NAME is '附件名';
COMMENT ON COLUMN TEDFA12.FILE_URL is '附件URL';


CREATE TABLE TEDFA13
(
    REC_CREATOR      VARCHAR2(16)  DEFAULT ' ' NOT NULL,
    REC_CREATOR_NAME VARCHAR2(100) DEFAULT ' ' NOT NULL,
    REC_REVISOR      VARCHAR2(16)  DEFAULT ' ' NOT NULL,
    ...
    UUID             VARCHAR2(32)  DEFAULT ' ' NOT NULL
        CONSTRAINT PK_TEDFA13
        PRIMARY KEY,
    PROJECT_ENAME    VARCHAR2(32)  DEFAULT ' ' NOT NULL,
    FORM_ENAME       VARCHAR2(60)  DEFAULT ' ' NOT NULL,
    COLOR            VARCHAR2(60)  DEFAULT ' ' NOT NULL,
    FORM_CNAME       VARCHAR2(60)  DEFAULT ' ' NOT NULL,
    FORM_GROUP       VARCHAR2(200) DEFAULT ' ' NOT NULL,
    DEL_FLAG         INTEGER      DEFAULT 0   NOT NULL,
    FILE_URL         VARCHAR2(500) DEFAULT ' ' NOT NULL,
    FORM_TYPE        VARCHAR2(3)   DEFAULT ' ' NOT NULL,
    FILE_NAME        VARCHAR2(200) DEFAULT ' ' NOT NULL,
    SORT_ID          VARCHAR2(20)  DEFAULT ' ' NOT NULL,
    IF_GROUP         VARCHAR2(5)   DEFAULT ' ' NOT NULL
);
COMMENT ON TABLE TEDFA13 is '快捷通道信息表';
COMMENT ON COLUMN TEDFA13.REC_CREATOR is '记录创建人';
COMMENT ON COLUMN TEDFA13.REC_CREATOR_NAME is '记录创建人姓名';
COMMENT ON COLUMN TEDFA13.REC_REVISOR is '记录修改人';
COMMENT ON COLUMN TEDFA13.REC_REVISOR_NAME is '记录修改人姓名';
COMMENT ON COLUMN TEDFA13.REC_REVISE_TIME is '记录修改时间';
COMMENT ON COLUMN TEDFA13.REC_CREATE_TIME is '记录创建时间';
COMMENT ON COLUMN TEDFA13.TENANT_ID is '租户';
COMMENT ON COLUMN TEDFA13.ARCHIVE_FLAG is '归档标记';
COMMENT ON COLUMN TEDFA13.UUID is 'ID';
COMMENT ON COLUMN TEDFA13.PROJECT_ENAME is '所属系统';
COMMENT ON COLUMN TEDFA13.FORM_ENAME is '画面英文';
COMMENT ON COLUMN TEDFA13.COLOR is '颜色';
COMMENT ON COLUMN TEDFA13.FORM_CNAME is '画面中文';
COMMENT ON COLUMN TEDFA13.FORM_GROUP is '分组';
COMMENT ON COLUMN TEDFA13.DEL_FLAG is '记录删除标记';
COMMENT ON COLUMN TEDFA13.FILE_URL is '文件下载路径';
COMMENT ON COLUMN TEDFA13.FORM_TYPE is '类型';
COMMENT ON COLUMN TEDFA13.FILE_NAME is '文件名';
COMMENT ON COLUMN TEDFA13.IF_GROUP is '是否显示分组';
...
CREATE TABLE TEDFM00 (
        DIRECTORY_ID VARCHAR2(32) DEFAULT ' ' NOT NULL,
        DIRECTORY_ENAME VARCHAR2(32) DEFAULT ' ' NOT NULL,
        DIRECTORY_CNAME VARCHAR2(80) DEFAULT ' ' NOT NULL,
        PARENT_DIRECTORY_ID VARCHAR2(32) DEFAULT ' ' NOT NULL,
        DIRECTORY_DESC VARCHAR2(512) DEFAULT ' ' NOT NULL,
        REC_CREATOR VARCHAR2(16) DEFAULT ' ' NOT NULL,
        REC_CREATE_TIME VARCHAR2(17) DEFAULT ' ' NOT NULL,
        REC_REVISOR VARCHAR2(16) DEFAULT ' ' NOT NULL,
        REC_REVISE_TIME VARCHAR2(17) DEFAULT ' ' NOT NULL,
...
COMMENT ON COLUMN TEDFM00.DIRECTORY_ID IS '目录标识';
COMMENT ON COLUMN TEDFM00.DIRECTORY_ENAME IS '目录编码';
COMMENT ON COLUMN TEDFM00.DIRECTORY_CNAME IS '目录显示名称';
COMMENT ON COLUMN TEDFM00.PARENT_DIRECTORY_ID IS '父目录标识';
COMMENT ON COLUMN TEDFM00.DIRECTORY_DESC IS '目录描述';
COMMENT ON COLUMN TEDFM00.REC_CREATOR IS '记录创建责任者';
COMMENT ON COLUMN TEDFM00.REC_CREATE_TIME IS '记录创建时刻';
COMMENT ON COLUMN TEDFM00.REC_REVISOR IS '记录修改责任者';
COMMENT ON COLUMN TEDFM00.REC_REVISE_TIME IS '记录修改时刻';
COMMENT ON COLUMN TEDFM00.ARCHIVE_FLAG IS '归档标记';
COMMENT ON COLUMN TEDFM00.TENANT_ID IS '租户ID';
COMMENT ON TABLE TEDFM00 IS '自定义表单目录维护表';
ALTER TABLE TEDFM00 ADD CONSTRAINT PK_TEDFM00 PRIMARY KEY (DIRECTORY_ID);

CREATE TABLE TEDFM01 (
        FORM_ID VARCHAR2(32) DEFAULT ' ' NOT NULL,
        FORM_ENAME VARCHAR2(20) DEFAULT ' ' NOT NULL,
        FORM_CNAME VARCHAR2(80) DEFAULT ' ' NOT NULL,
        JSON_DATA BLOB,
        FORM_DESC VARCHAR2(512) DEFAULT ' ' NOT NULL,
        FORM_STATUS VARCHAR2(1) DEFAULT '0' NOT NULL,
        TABLE_ID VARCHAR2(32) DEFAULT ' ' NOT NULL,
        CATEGORY_ID VARCHAR2(32) DEFAULT ' ' NOT NULL,
        DESIGN_TYPE VARCHAR2(1) DEFAULT '0' NOT NULL,
        REC_CREATOR VARCHAR2(16) DEFAULT ' ' NOT NULL,
        REC_CREATE_TIME VARCHAR2(17) DEFAULT ' ' NOT NULL,
        REC_REVISOR VARCHAR2(16) DEFAULT ' ' NOT NULL,
        REC_REVISE_TIME VARCHAR2(17) DEFAULT ' ' NOT NULL,
        ARCHIVE_FLAG VARCHAR2(1) DEFAULT ' ' NOT NULL,
        TENANT_ID VARCHAR2(64) DEFAULT ' ' NOT NULL,
        CONSTRAINT UNI_TEDFM01
        UNIQUE (FORM_ENAME)
    );
COMMENT ON COLUMN TEDFM01.FORM_ID IS '表单标识';
COMMENT ON COLUMN TEDFM01.FORM_ENAME IS '表单编码';
COMMENT ON COLUMN TEDFM01.FORM_CNAME IS '表单中文名';
COMMENT ON COLUMN TEDFM01.JSON_DATA IS '表单结构定义';
COMMENT ON COLUMN TEDFM01.FORM_DESC IS '表单描述';
COMMENT ON COLUMN TEDFM01.FORM_STATUS IS '表单状态';
COMMENT ON COLUMN TEDFM01.TABLE_ID IS '关联数据表名';
COMMENT ON COLUMN TEDFM01.CATEGORY_ID IS '所在的表单目录节点';
COMMENT ON COLUMN TEDFM01.DESIGN_TYPE IS '是否引用表单';
COMMENT ON COLUMN TEDFM01.REC_CREATOR IS '记录创建责任者';
COMMENT ON COLUMN TEDFM01.REC_CREATE_TIME IS '记录创建时刻';
COMMENT ON COLUMN TEDFM01.REC_REVISOR IS '记录修改责任者';
COMMENT ON COLUMN TEDFM01.REC_REVISE_TIME IS '记录修改时刻';
COMMENT ON COLUMN TEDFM01.ARCHIVE_FLAG IS '归档标记';
COMMENT ON COLUMN TEDFM01.TENANT_ID IS '租户ID';
COMMENT ON TABLE TEDFM01 IS '自定义表单数据维护表';
ALTER TABLE TEDFM01 ADD CONSTRAINT PK_TEDFM01 PRIMARY KEY (FORM_ID);
...
CREATE TABLE TEUDM40
(
    ID                  VARCHAR(64) NOT NULL,
    FILE_NAME           VARCHAR(125) NOT NULL,
    URL                 VARCHAR(255) NOT NULL,
    REC_CREATE_TIME     VARCHAR(17) NOT NULL,
    STATUS              INTEGER DEFAULT 0 NOT NULL,
    REC_CREATOR         VARCHAR(32) DEFAULT ' ',
    REC_CREATOR_NAME    VARCHAR(100) DEFAULT ' ',
    REC_REVISOR         VARCHAR(32) DEFAULT ' ',
    REC_REVISOR_NAME    VARCHAR(100) DEFAULT ' ',
    REC_REVISOR_TIME    VARCHAR(17) DEFAULT ' ',
    DEL_FLAG            SMALLINT DEFAULT 0,
    ARCHIVE_FLAG        VARCHAR(1) DEFAULT ' ',
    SEG_NO              VARCHAR(10) DEFAULT ' ',
    REMARK              VARCHAR(255) DEFAULT ' ',
    DIFFERENCE_TIME     VARCHAR(15) DEFAULT ' '
);
alter table TEUDM40 add constraint PK_TEUDM40  primary key (ID);

COMMENT ON TABLE TEUDM40 IS '生成文件信息表';
COMMENT ON COLUMN TEUDM40.ID IS '文件ID';
COMMENT ON COLUMN TEUDM40.FILE_NAME IS '文件名';
COMMENT ON COLUMN TEUDM40.URL IS '文件URL';
COMMENT ON COLUMN TEUDM40.REC_CREATE_TIME IS '记录创建时间';
COMMENT ON COLUMN TEUDM40.STATUS IS '状态';
COMMENT ON COLUMN TEUDM40.REC_CREATOR IS '记录创建者';
COMMENT ON COLUMN TEUDM40.REC_CREATOR_NAME IS '记录创建者姓名';
COMMENT ON COLUMN TEUDM40.REC_REVISOR IS '记录修改者';
COMMENT ON COLUMN TEUDM40.REC_REVISOR_NAME IS '记录修改者姓名';
COMMENT ON COLUMN TEUDM40.REC_REVISOR_TIME IS '记录修改时间';
COMMENT ON COLUMN TEUDM40.DEL_FLAG IS '删除标记';
COMMENT ON COLUMN TEUDM40.ARCHIVE_FLAG IS '归档标记';
COMMENT ON COLUMN TEUDM40.SEG_NO IS '段号';
COMMENT ON COLUMN TEUDM40.REMARK IS '备注';
COMMENT ON COLUMN TEUDM40.DIFFERENCE_TIME IS '差异时间';



create table TEDPI13
(
    SEQ_ID           VARCHAR(50)            not null,
    ERROR_NUM        VARCHAR(20)            not null,
    SYSTEM_CODE      VARCHAR(10) default '' not null,
    SYSTEM_NAME      VARCHAR(50) default '' not null,
    APP_CODE         VARCHAR(10) default '' not null,
    APP_NAME         VARCHAR(50) default '' not null,
    FORM_ENAME       VARCHAR(10) default '' not null,
    FORM_CNAME       VARCHAR(50) default '' not null,
    BUTTON_ENAME     VARCHAR(10) default '' not null,
    BUTTON_CNAME     VARCHAR(60) default '' not null,
    SERVICE_ENAME    VARCHAR(20)  default '' not null,
    SERVICE_CNAME    VARCHAR(20) default '' not null,
    ERROR_TYPE       VARCHAR(20) default '' not null,
    MESSAGE_TEXT     VARCHAR(200) default '' not null,
    SOLUTION         VARCHAR(200) default '' not null,
    ...
    MESSAGE_NUM_TEXT     VARCHAR(100)  default '' not null,
    DEL_FLAG     int          default 0 not null,
    PARA_LIST     VARCHAR(2000)  default '' not null,
    USAGE_SCENE     VARCHAR(2000)  default '' not null,
    REMARK     VARCHAR(2000)  default '' not null,
    LOCALES     VARCHAR(20)  default '' not null
);
alter table TEDPI13 add constraint PK_TEDPI13  primary key (SEQ_ID);

comment on table TEDPI13 is '系统画面报错配置表';
comment on column TEDPI13.SEQ_ID is '流水号';
comment on column TEDPI13.ERROR_NUM is '报错编号';
comment on column TEDPI13.SYSTEM_CODE is '系统别';
comment on column TEDPI13.SYSTEM_NAME is '系统名';
comment on column TEDPI13.APP_CODE is '应用编号';
comment on column TEDPI13.APP_NAME is '应用名';
comment on column TEDPI13.FORM_ENAME is '画面编号';
comment on column TEDPI13.FORM_CNAME is '画面名称';
comment on column TEDPI13.BUTTON_ENAME is '按钮编号';
comment on column TEDPI13.BUTTON_CNAME is '按钮名称';
comment on column TEDPI13.SERVICE_ENAME is '服务编号';
comment on column TEDPI13.SERVICE_CNAME is '服务名称';
comment on column TEDPI13.ERROR_TYPE is '报错分类';
comment on column TEDPI13.MESSAGE_TEXT is '报错描述';
comment on column TEDPI13.SOLUTION is '处置建议';
comment on column TEDPI13.REC_CREATOR is '记录创建人';
comment on column TEDPI13.REC_CREATOR_NAME is '记录创建人姓名';
comment on column TEDPI13.REC_CREATE_TIME is '记录创建时间';
comment on column TEDPI13.REC_REVISOR is '记录修改人';
comment on column TEDPI13.REC_REVISOR_NAME is '记录修改人姓名';
comment on column TEDPI13.REC_REVISE_TIME is '记录修改时间';
comment on column TEDPI13.ARCHIVE_FLAG is '归档标志';
comment on column TEDPI13.MESSAGE_NUM_TEXT is '报错编号描述';
comment on column TEDPI13.DEL_FLAG is '删除标志';
comment on column TEDPI13.PARA_LIST is '参数列表';
comment on column TEDPI13.USAGE_SCENE is '适用场景';
comment on column TEDPI13.REMARK is '备注说明';
comment on column TEDPI13.LOCALES is '国际化标识';

create table TEDPI14
(
    SEQ_ID           varchar(50)              not null,
    ERROR_NUM        varchar(20)              not null,
    SYSTEM_CODE      varchar(10)   default '' not null,
...
alter table TEDPI14 add constraint PK_TEDPI14  primary key (SEQ_ID);

comment on table TEDPI14 is '系统画面报错配置应用登记表';
comment on column TEDPI14.SEQ_ID is '流水号';
comment on column TEDPI14.ERROR_NUM is '报错编号';
comment on column TEDPI14.SYSTEM_CODE is '系统别';
comment on column TEDPI14.SYSTEM_NAME is '系统名';
comment on column TEDPI14.APP_CODE is '应用编号';
comment on column TEDPI14.APP_NAME is '应用名';
comment on column TEDPI14.FORM_ENAME is '画面编号';
comment on column TEDPI14.FORM_CNAME is '画面名称';
comment on column TEDPI14.BUTTON_ENAME is '按钮编号';
comment on column TEDPI14.BUTTON_CNAME is '按钮名称';
comment on column TEDPI14.SERVICE_ENAME is '服务编号';
comment on column TEDPI14.SERVICE_CNAME is '服务名称';
comment on column TEDPI14.REC_CREATOR is '记录创建人';
comment on column TEDPI14.REC_CREATOR_NAME is '记录创建人姓名';
comment on column TEDPI14.REC_CREATE_TIME is '记录创建时间';
comment on column TEDPI14.REC_REVISOR is '记录修改人';
comment on column TEDPI14.REC_REVISOR_NAME is '记录修改人姓名';
comment on column TEDPI14.REC_REVISE_TIME is '记录修改时间';
comment on column TEDPI14.ARCHIVE_FLAG is '归档标志';
comment on column TEDPI14.DEL_FLAG is '删除标志';
comment on column TEDPI14.REMARK is '备注说明';

create table TEDPI15
(
    SEQ_ID           VARCHAR(50)            not null,
    ERROR_NUM        VARCHAR(20)            not null,
    SYSTEM_CODE      VARCHAR(10) default '' not null,
...
alter table TEDPI15 add constraint PK_TEDPI15  primary key (SEQ_ID);

comment on table TEDPI15 is '统一报错履历表';
comment on column TEDPI15.SEQ_ID is '流水号';
comment on column TEDPI15.ERROR_NUM is '报错编号';
comment on column TEDPI15.SYSTEM_CODE is '系统别';
comment on column TEDPI15.SYSTEM_NAME is '系统名';
comment on column TEDPI15.APP_CODE is '应用编号';
comment on column TEDPI15.APP_NAME is '应用名';
comment on column TEDPI15.FORM_ENAME is '画面编号';
comment on column TEDPI15.FORM_CNAME is '画面名称';
comment on column TEDPI15.BUTTON_ENAME is '按钮编号';
comment on column TEDPI15.BUTTON_CNAME is '按钮名称';
comment on column TEDPI15.SERVICE_ENAME is '服务编号';
comment on column TEDPI15.SERVICE_CNAME is '服务名称';
comment on column TEDPI15.ERROR_TYPE is '报错分类';
comment on column TEDPI15.MESSAGE_TEXT is '报错描述';
comment on column TEDPI15.SOLUTION is '处置建议';
comment on column TEDPI15.REC_CREATOR is '记录创建人';
comment on column TEDPI15.REC_CREATOR_NAME is '记录创建人姓名';
comment on column TEDPI15.REC_CREATE_TIME is '记录创建时间';
comment on column TEDPI15.REC_REVISOR is '记录修改人';
comment on column TEDPI15.REC_REVISOR_NAME is '记录修改人姓名';
comment on column TEDPI15.REC_REVISE_TIME is '记录修改时间';
comment on column TEDPI15.ARCHIVE_FLAG is '归档标志';
comment on column TEDPI15.MESSAGE_NUM_TEXT is '报错编号描述';
comment on column TEDPI15.DEL_FLAG is '删除标志';
comment on column TEDPI15.PARA_LIST is '参数列表';
comment on column TEDPI15.USAGE_SCENE is '适用场景';
comment on column TEDPI15.REMARK is '备注说明';
...
CREATE TABLE TEUDM02 (
  ...
  ARCHIVE_FLAG VARCHAR2(1)  DEFAULT ' '    NOT NULL ,
  TENANT_ID VARCHAR2(64)  DEFAULT ' '    NOT NULL,
  SHARED_DOC_TYPE VARCHAR2(2) DEFAULT '0' NOT NULL
);
...
CREATE TABLE TEWPI03 (
     FORM_FIELD_ID VARCHAR2(32) DEFAULT ' ' NOT NULL,
     FORM_FIELD_KEY VARCHAR2(255) DEFAULT ' ' NOT NULL,
     PROCESS_INSTANCE_ID VARCHAR2(64) DEFAULT ' ' NOT NULL,
     FORM_FIELD_LONG_VALUE NUMBER(20) DEFAULT 0 NOT NULL,
     FORM_FIELD_STRING_VALUE VARCHAR2(255) DEFAULT ' ' NOT NULL,
     FORM_FIELD_DOUBLE_VALUE NUMBER(31,10) DEFAULT 0 NOT NULL,
     FORM_FIELD_DATE_VALUE VARCHAR2(17) DEFAULT ' ' NOT NULL,
     FORM_FIELD_TEXT_VALUE VARCHAR2(2000) DEFAULT ' ' NOT NULL,
     FORM_FIELD_TYPE VARCHAR2(2) DEFAULT '0' NOT NULL,
     REC_CREATOR VARCHAR2(16) DEFAULT ' ' NOT NULL,
     REC_CREATE_TIME VARCHAR2(17) DEFAULT ' ' NOT NULL,
     REC_REVISOR VARCHAR2(16) DEFAULT ' ' NOT NULL,
     REC_REVISE_TIME VARCHAR2(17) DEFAULT ' ' NOT NULL,
...
ALTER TABLE TEWPI03 ADD CONSTRAINT PK_TEWPI03 PRIMARY KEY (FORM_FIELD_ID);
COMMENT ON TABLE TEWPI03 IS '流程实例相关数据表';
COMMENT ON COLUMN TEWPI03.FORM_FIELD_ID IS '字段的ID';
COMMENT ON COLUMN TEWPI03.FORM_FIELD_KEY IS '字段的编码';
COMMENT ON COLUMN TEWPI03.PROCESS_INSTANCE_ID IS '流程实例ID';
COMMENT ON COLUMN TEWPI03.FORM_FIELD_LONG_VALUE IS 'Long型的值';
COMMENT ON COLUMN TEWPI03.FORM_FIELD_STRING_VALUE IS 'String型的值';
COMMENT ON COLUMN TEWPI03.FORM_FIELD_DOUBLE_VALUE IS 'Double型的值';
COMMENT ON COLUMN TEWPI03.FORM_FIELD_DATE_VALUE IS 'Date型的值';
COMMENT ON COLUMN TEWPI03.FORM_FIELD_TEXT_VALUE IS 'Text型的值';
COMMENT ON COLUMN TEWPI03.FORM_FIELD_TYPE IS '类型';
COMMENT ON COLUMN TEWPI03.REC_CREATOR IS '记录创建责任者';
COMMENT ON COLUMN TEWPI03.REC_CREATE_TIME IS '记录创建时刻';
COMMENT ON COLUMN TEWPI03.REC_REVISOR IS '记录修改责任者';
COMMENT ON COLUMN TEWPI03.REC_REVISE_TIME IS '记录修改时刻';
COMMENT ON COLUMN TEWPI03.ARCHIVE_FLAG IS '归档标记';
COMMENT ON COLUMN TEWPI03.TENANT_ID IS '租户ID';
...
(
    ...
    RES_ENAME          VARCHAR2(500) DEFAULT ' '     NOT NULL,
...
(
    ...
    OPERATE_END_TIME   VARCHAR2(17)   default ' ' not null,
...
create index IDX_EM_RECEIVE_ORI_UUID
	on EM_RECEIVE_QUEUE (ORI_UUID);

create index IDX_EM_RECEIVE_QUEUE_GROUP_NAME
	on EM_RECEIVE_QUEUE (GROUP_NAME);

create index IDX_EM_RECEIVE_QUEUE_STATUS
	on EM_RECEIVE_QUEUE (QUEUE_STAUS);


create index IDX_EM_SEND_ORI_UUID
	on EM_SEND_QUEUE (ORI_UUID);

create index IDX_EM_SEND_QUEUE_GROUP_NAME
	on EM_SEND_QUEUE (GROUP_NAME);

create index IDX_EM_SEND_QUEUE_STATUS
	on EM_SEND_QUEUE (QUEUE_STAUS);
...
CREATE TABLE TEDDBS0 (
                         DATASOURCE_ID VARCHAR2(64) NOT NULL  DEFAULT ' '
                             CONSTRAINT PK_TEDDBS0
                             PRIMARY KEY,
                         CONNECT_NAME VARCHAR2(128) NOT NULL  DEFAULT ' ' ,
                         CONNECT_SCHEMA VARCHAR2(128) NOT NULL  DEFAULT ' ',
                         DB_TYPE VARCHAR2(16) NOT NULL  DEFAULT ' ',
                         DB_HOST VARCHAR2(255) NOT NULL  DEFAULT ' ',
                         DB_PORT VARCHAR2(16) NOT NULL  DEFAULT ' ',
                         ITEM_DB_NAME VARCHAR2(128) NOT NULL  DEFAULT ' ',
                         ITEM_USERNAME VARCHAR2(32) NOT NULL  DEFAULT ' ',
                         ITEM_PASSWORD VARCHAR2(100) NOT NULL  DEFAULT ' ',
                         ITEM_PARAMS VARCHAR2(1024) NOT NULL  DEFAULT ' ',
                         IS_AUTH VARCHAR2(1) NOT NULL  DEFAULT '0',
                         REC_CREATOR VARCHAR2(16) NOT NULL  DEFAULT ' ',
                         REC_CREATE_TIME VARCHAR2(17) NOT NULL  DEFAULT ' ',
                         REC_REVISOR VARCHAR2(16) NOT NULL  DEFAULT ' ',
                         REC_REVISE_TIME VARCHAR2(17) NOT NULL  DEFAULT ' ',
                         ARCHIVE_FLAG VARCHAR2(1) NOT NULL  DEFAULT ' '
);
COMMENT ON TABLE TEDDBS0 is '数据源信息';
COMMENT ON COLUMN TEDDBS0.REC_CREATOR is '记录创建人';
COMMENT ON COLUMN TEDDBS0.REC_REVISOR is '记录修改人';
COMMENT ON COLUMN TEDDBS0.REC_REVISE_TIME is '记录修改时间';
COMMENT ON COLUMN TEDDBS0.REC_CREATE_TIME is '记录创建时间';
COMMENT ON COLUMN TEDDBS0.ARCHIVE_FLAG is '归档标记';
COMMENT ON COLUMN TEDDBS0.IS_AUTH is '是否授权';
COMMENT ON COLUMN TEDDBS0.ITEM_PARAMS is '参数';
COMMENT ON COLUMN TEDDBS0.ITEM_PASSWORD is '密码';
COMMENT ON COLUMN TEDDBS0.ITEM_USERNAME is '用户名';
COMMENT ON COLUMN TEDDBS0.ITEM_DB_NAME is '数据库名';
COMMENT ON COLUMN TEDDBS0.DB_PORT is '端口';
COMMENT ON COLUMN TEDDBS0.DB_HOST is '主机';
COMMENT ON COLUMN TEDDBS0.DB_TYPE is '数据库类型';
COMMENT ON COLUMN TEDDBS0.CONNECT_SCHEMA is '连接配置schema';
COMMENT ON COLUMN TEDDBS0.CONNECT_NAME is '连接名';
COMMENT ON COLUMN TEDDBS0.DATASOURCE_ID is '数据源标识';

CREATE TABLE ED_XM_SERVICE_RES_RELA
(
    SERVICE_ENAME         VARCHAR2(64)  DEFAULT ' '   NOT NULL,
    METHOD_ENAME          VARCHAR2(64)  DEFAULT ' '   NOT NULL,
    FORM_ENAME            VARCHAR2(20)  DEFAULT ' '   NOT NULL,
    BUTTON_ENAME          VARCHAR2(100)  DEFAULT ' '   NOT NULL,
    RES_ID                VARCHAR2(50)  DEFAULT ' '   NOT NULL,
    REC_CREATOR           VARCHAR2(16)  DEFAULT ' '   NOT NULL,
    REC_CREATE_TIME       VARCHAR2(17)  DEFAULT ' '   NOT NULL,
    REC_REVISOR           VARCHAR2(16)  DEFAULT ' '   NOT NULL,
    REC_REVISE_TIME       VARCHAR2(17)  DEFAULT ' '   NOT NULL,
...
(
    ...
    REC_REVISE_TIME         VARCHAR2(17)  DEFAULT ' '   NOT NULL,
    ARCHIVE_FLAG            VARCHAR2(1)  DEFAULT ' '   NOT NULL,
    TENANT_ID               VARCHAR2(64)  DEFAULT ' BDAS'   NOT NULL,
    RULE_UUID               VARCHAR2(32)  DEFAULT ' '   NOT NULL,
    RULE_DESC               VARCHAR2(128)  DEFAULT ' '   NOT NULL,
    TARGET_CHARACTER        VARCHAR2(32)  DEFAULT ' '   NOT NULL,
    REPLACE_CHARACTER       VARCHAR2(32)  DEFAULT ' '   NOT NULL,
    SORT_INDEX              NUMBER(4,0)  DEFAULT 0   NOT NULL
);
...
(
    ...
    TENANT_ID               VARCHAR2(64)  DEFAULT ' BDAS'   NOT NULL,
    RULE_UUID               VARCHAR2(32)  DEFAULT ' '   NOT NULL,
    WHITELIST_TYPE          VARCHAR2(2)  DEFAULT ' '   NOT NULL,
    WHITELIST_KEYWORD       VARCHAR2(32)  DEFAULT ' '   NOT NULL,
    WHITELIST_DESC          VARCHAR2(128)  DEFAULT ' '   NOT NULL,
    SORT_INDEX              NUMBER(4,0)  DEFAULT 0   NOT NULL
);
...
alter table TEWOG01 add constraint PK_TEWOG01 primary key (ORG_ID,PROCESS_KEY);

COMMENT ON TABLE TEWOG01 IS '流程定义与组织机构关联关系表';
COMMENT ON COLUMN TEWOG01.ORG_ID IS '组织机构编码';
COMMENT ON COLUMN TEWOG01.ORG_ENAME IS '组织机构英文名';
COMMENT ON COLUMN TEWOG01.PROCESS_KEY IS '流程定义编码';
COMMENT ON COLUMN TEWOG01.PROCESS_NAME IS '流程定义名称 ';
COMMENT ON COLUMN TEWOG01.REC_CREATOR IS '记录创建责任者';
COMMENT ON COLUMN TEWOG01.REC_CREATE_TIME IS '记录创建时刻';
COMMENT ON COLUMN TEWOG01.REC_REVISOR IS '记录修改责任者';
COMMENT ON COLUMN TEWOG01.REC_REVISE_TIME IS '记录修改时刻';
COMMENT ON COLUMN TEWOG01.ARCHIVE_FLAG IS '归档标记';
COMMENT ON COLUMN TEWOG01.TENANT_ID IS '租户ID';
