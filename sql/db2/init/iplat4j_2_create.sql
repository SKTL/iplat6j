...
CREATE TABLE TEDDBS0 (
                         DATASOURCE_ID VARCHAR(64) NOT NULL  DEFAULT ' '
                             CONSTRAINT PK_TEDDBS0
                                 PRIMARY KEY,
                         CONNECT_NAME VARCHAR(128) NOT NULL  DEFAULT ' ' ,
                         CONNECT_SCHEMA VARCHAR(128) NOT NULL  DEFAULT ' ',
                         DB_TYPE VARCHAR(16) NOT NULL  DEFAULT ' ',
                         DB_HOST VARCHAR(255) NOT NULL  DEFAULT ' ',
                         DB_PORT VARCHAR(16) NOT NULL  DEFAULT ' ',
                         ITEM_DB_NAME VARCHAR(128) NOT NULL  DEFAULT ' ',
                         ITEM_USERNAME VARCHAR(32) NOT NULL  DEFAULT ' ',
                         ITEM_PASSWORD VARCHAR(100) NOT NULL  DEFAULT ' ',
                         ITEM_PARAMS VARCHAR(1024) NOT NULL  DEFAULT ' ',
                         IS_AUTH VARCHAR(1) NOT NULL  DEFAULT '0',
                         REC_CREATOR VARCHAR(16) NOT NULL  DEFAULT ' ',
                         REC_CREATE_TIME VARCHAR(17) NOT NULL  DEFAULT ' ',
                         REC_REVISOR VARCHAR(16) NOT NULL  DEFAULT ' ',
                         REC_REVISE_TIME VARCHAR(17) NOT NULL  DEFAULT ' ',
...
CREATE TABLE TEDFA10 (
  ...
  TENANT_ID VARCHAR(64)  DEFAULT ' '    NOT NULL,
  FORM_GROUP VARCHAR(64)  DEFAULT ' '    NOT NULL,
  CUSTOM_CNAME VARCHAR(255)  DEFAULT ' '    NOT NULL,
  COLOR VARCHAR(50)  DEFAULT ' '    NOT NULL,
  SHOW_FLAG VARCHAR(10)  DEFAULT ' '    NOT NULL
) IN DS_IPLAT4J01;
...
(
    REC_CREATOR        VARCHAR(16)   DEFAULT ' ' NOT NULL,
    REC_CREATOR_NAME   VARCHAR(100)   DEFAULT ' ' NOT NULL,
    REC_CREATE_TIME    VARCHAR(17)   DEFAULT ' ' NOT NULL,
    REC_REVISOR        VARCHAR(16)   DEFAULT ' ' NOT NULL,
    REC_REVISOR_NAME   VARCHAR(100)   DEFAULT ' ' NOT NULL,
    REC_REVISE_TIME    VARCHAR(17)   DEFAULT ' ' NOT NULL,
    TENANT_ID          VARCHAR(64)   DEFAULT ' ' NOT NULL,
    ARCHIVE_FLAG       VARCHAR(1)    DEFAULT ' ' NOT NULL,
    TIME_STAMP         VARCHAR(18)   DEFAULT ' ' NOT NULL
        CONSTRAINT PK_TEDFA11
            PRIMARY KEY,
    GD_CONTENT         VARCHAR(1000) DEFAULT ' ' NOT NULL,
    FB_STATE           VARCHAR(2)    DEFAULT ' ' NOT NULL,
    ORDER_IDENTIFY     VARCHAR(4)    DEFAULT ' ' NOT NULL,
    TITLE              VARCHAR(100)  DEFAULT ''  NOT NULL,
    MSG_TYPE           VARCHAR(20)   DEFAULT ''  NOT NULL,
    REC_PUBLISH_TIME   VARCHAR(14)   DEFAULT ''  NOT NULL,
    REC_PUBLISHER      VARCHAR(20)   DEFAULT ''  NOT NULL,
    REC_PUBCANCEL_TIME VARCHAR(14)   DEFAULT ''  NOT NULL
) IN DS_IPLAT4J01;
...
(
    ...
    FILE_URL   VARCHAR(120) DEFAULT '' NOT NULL
) IN DS_IPLAT4J01;
...
(
    ...
    UUID             VARCHAR(32)  DEFAULT ' ' NOT NULL
        CONSTRAINT PK_TEDFA13
            PRIMARY KEY,
    PROJECT_ENAME    VARCHAR(32)  DEFAULT ' ' NOT NULL,
    FORM_ENAME       VARCHAR(60)  DEFAULT ' ' NOT NULL,
    COLOR            VARCHAR(60)  DEFAULT ' ' NOT NULL,
    FORM_CNAME       VARCHAR(60)  DEFAULT ' ' NOT NULL,
    FORM_GROUP       VARCHAR(200) DEFAULT ' ' NOT NULL,
    DEL_FLAG         INTEGER      DEFAULT 0   NOT NULL,
    FILE_URL         VARCHAR(500) DEFAULT ' ' NOT NULL,
    FORM_TYPE        VARCHAR(3)   DEFAULT ' ' NOT NULL,
    FILE_NAME        VARCHAR(200) DEFAULT ' ' NOT NULL,
    SORT_ID          VARCHAR(20)  DEFAULT ' ' NOT NULL,
    IF_GROUP         VARCHAR(5)   DEFAULT ' ' NOT NULL
) IN DS_IPLAT4J01;
...
CREATE TABLE TEDFM00 (
    DIRECTORY_ID VARCHAR(32) DEFAULT ' ' NOT NULL,
    DIRECTORY_ENAME VARCHAR(32) DEFAULT ' ' NOT NULL,
    DIRECTORY_CNAME VARCHAR(80) DEFAULT ' ' NOT NULL,
    PARENT_DIRECTORY_ID VARCHAR(32) DEFAULT ' ' NOT NULL,
    DIRECTORY_DESC VARCHAR(512) DEFAULT ' ' NOT NULL,
    REC_CREATOR VARCHAR(16) DEFAULT ' ' NOT NULL,
    REC_CREATE_TIME VARCHAR(17) DEFAULT ' ' NOT NULL,
    REC_REVISOR VARCHAR(16) DEFAULT ' ' NOT NULL,
    REC_REVISE_TIME VARCHAR(17) DEFAULT ' ' NOT NULL,
...
CREATE TABLE TEDFM01 (
    FORM_ID VARCHAR(32) DEFAULT ' ' NOT NULL,
    FORM_ENAME VARCHAR(20) DEFAULT ' ' NOT NULL,
    FORM_CNAME VARCHAR(80) DEFAULT ' ' NOT NULL,
    JSON_DATA BLOB(2097152),
    FORM_DESC VARCHAR(512) DEFAULT ' ' NOT NULL,
    FORM_STATUS VARCHAR(1) DEFAULT ' ' NOT NULL,
    TABLE_ID VARCHAR(32) DEFAULT ' ' NOT NULL,
    CATEGORY_ID VARCHAR(32) DEFAULT ' ' NOT NULL,
    DESIGN_TYPE VARCHAR(1) DEFAULT ' ' NOT NULL,
    REC_CREATOR VARCHAR(16) DEFAULT ' ' NOT NULL,
    REC_CREATE_TIME VARCHAR(17) DEFAULT ' ' NOT NULL,
    REC_REVISOR VARCHAR(16) DEFAULT ' ' NOT NULL,
    REC_REVISE_TIME VARCHAR(17) DEFAULT ' ' NOT NULL,
...
CREATE TABLE TEWPI03 (
    FORM_FIELD_ID VARCHAR(32) DEFAULT ' ' NOT NULL,
    FORM_FIELD_KEY VARCHAR(255) DEFAULT ' ' NOT NULL,
    PROCESS_INSTANCE_ID VARCHAR(64) DEFAULT ' ' NOT NULL,
    FORM_FIELD_LONG_VALUE DECIMAL(20) DEFAULT 0 NOT NULL,
    FORM_FIELD_STRING_VALUE VARCHAR(255) DEFAULT ' ' NOT NULL,
    FORM_FIELD_DOUBLE_VALUE DECIMAL(31,10) DEFAULT 0 NOT NULL,
    FORM_FIELD_DATE_VALUE VARCHAR(17) DEFAULT ' ' NOT NULL,
    FORM_FIELD_TEXT_VALUE VARCHAR(2000) DEFAULT ' ' NOT NULL,
    FORM_FIELD_TYPE VARCHAR(2) DEFAULT '0' NOT NULL,
    REC_CREATOR VARCHAR(16) DEFAULT ' ' NOT NULL,
    REC_CREATE_TIME VARCHAR(17) DEFAULT ' ' NOT NULL,
    REC_REVISOR VARCHAR(16) DEFAULT ' ' NOT NULL,
    REC_REVISE_TIME VARCHAR(17) DEFAULT ' ' NOT NULL,
...
(
    ...
    RES_ENAME          VARCHAR(500) DEFAULT ' '     NOT NULL,
...
(
    ...
    OPERATE_END_TIME   VARCHAR(17)   default ' ' not null,
